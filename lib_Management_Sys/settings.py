"""
Django settings for lib_Management_Sys project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','lib-managment-system.onrender.com']
...
WSGI_APPLICATION = 'lib_Management_Sys.wsgi.application'
